...
export function handleSwap(event: SwapEvent): void {
  ...
  // interval data
  let foxchainDayData = updateFoxchainDayData(event)
  ...
  foxchainDayData.volumeETH = foxchainDayData.volumeETH.plus(amountTotalETHTracked)
  foxchainDayData.volumeUSD = foxchainDayData.volumeUSD.plus(amountTotalUSDTracked)
  foxchainDayData.feesUSD = foxchainDayData.feesUSD.plus(feesUSD)
